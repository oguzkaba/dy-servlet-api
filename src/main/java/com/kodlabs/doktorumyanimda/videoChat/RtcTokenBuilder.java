...
public class RtcTokenBuilder {
     ...
     *        + 600 (seconds).                             
     */
    public ResponseEntitySet<String> buildTokenWithUid(String appId, String appCertificate,
     ...
     *        + 600 (seconds).                             
     */
    public ResponseEntitySet<String> buildTokenWithUserAccount(String appId, String appCertificate,
    	...
    	try {
			return new ResponseEntitySet<>(builder.build());
		} catch (Exception e) {
