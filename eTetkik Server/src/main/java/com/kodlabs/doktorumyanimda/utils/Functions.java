    ...
    public static String nameFirstCharacterUpperCase(String data){
        ...
        if(data.contains(" ")){
            ...
            for (String name: names){
                ...
                result.append(name.substring(0, 1).toUpperCase(Locale.forLanguageTag("tr"))).append(name.substring(1)).append(" ");
            }
        }else{
            data = data.toLowerCase(Locale.forLanguageTag("tr"));
            result = new StringBuilder(data.substring(0, 1).toUpperCase(Locale.forLanguageTag("tr")) + data.substring(1));
        }
